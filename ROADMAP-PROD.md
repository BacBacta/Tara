...
**Dernière mise à jour** : 2026-08-28 — programme terminé, relecture de sécurité faite, photos stockées et affichées, adaptation 4G, onboarding et espace vendeuse refaits, + **répétition générale du pilote jouée sur PostgreSQL** (`JOUR-J.md`).
**État du code** : V1+V2 complets, Next 16.3.3 + React 19, fournisseurs simulés en dev, SQLite en dev / PostgreSQL prêt pour la prod.
234 tests SQLite + 8 tests PostgreSQL, build sans erreur.
